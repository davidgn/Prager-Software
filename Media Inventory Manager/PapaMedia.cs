...
namespace Media_Inventory_Manager
{
    class PapaMedia
    {
        ...
        //enum tMedia : int  //  enumerations for tMedia table (also found in MainForm)
        //{
        //    SKU, Title, Author, UPC, Illus, Locn, Price, Cost, TranC, Pub, PubPlace, PubYear, Keywds, Descr, Jaket, Bndg,  //  0-15
        //    Condn, Ed, Signed, Type, Size, DateA, DateU, Cat, Notes, Stat, InvoiceNbr, ExpediteShip, IntlShip, SubCategory,  //  16-29
        //    DoNotReprice, NbrOfPages, BookWeight, ImageURL, NbrOfCopies, Quantity, Shipping   //  30-36
        //};
        ...
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        //--    create Papa Media tab-delimited file
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        private bool buildTabDelimitedFile(FbDataReader data, TextWriter tw, ConvertUPC ci) {
            ...
            if (UPC.Length == 12)
                dataBuild = UPC + "\t\t";  //  UPC (required)
            else if (UPC.Length == 13)
                dataBuild = "\t" + UPC + "\t";  //  alternate
            else
                return false;
            ...
            dataBuild += data["MediaType"].ToString() + "\t";  //  format
