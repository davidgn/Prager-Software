...
namespace Media_Inventory_Manager
{
    ...
    partial class mainForm : Form
    {
        ...
        ////------------------------------------------------------------------------------------
        //private String readAddallBookInfo(string UPC)
        //{
        ...
        //    string remainderOfPostData = "?query=0916260755&type=UPC&location=10000&state=WA&dispCurr=USD";
        ...
        //    postsourcedata = "author=&title=&keyword=&UPC=" + UPC + remainderOfPostData;
        ...
        //    {
        //        MessageBox.Show("UPC not found", "Check data", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //        return -1;
        //    }
        ...
        //            //   by <a href=/author/2749492-1>Clarissa Pinkola Estes</a><BR><b>UPC:
        //            //  m^   m2^                   m3^                            m1^
        ...
        //            //  m^   m2^                    m3^              m^    
        //            //     <a href=/author/2996897-1>Michael Sadler</a><BR><b>UPC:
        //            //                                                   m1^
        ...
        //    //  <B>Mfgr: </B> William Morrow &amp; Company<BR>    -->0688159885
        //    //  m^                                                 m1^             
        //    //  do Mfgr
        //    string pubString = "";
        //    r = new Regex(@"<B>Mfgr:");
        ...
        ////------------------------------------------------------------------------------------
        //private String readCampusiBookInfo(string UPC)
        //{
        ...
        //        //  WebRequest.Create("http://www.campusi.com/bookFind/asp/bookFindPrefindLst.asp?srchTxtUPC=" + UPC);
        //    WebRequest.Create("http://www.campusi.com/bookFind/asp/bookFindPriceLst.asp?prodId=" + UPC);
        ...
        //    //  Mfgr
        //    r = new Regex("<br>Mfgr: ");  // find beginning
...
//http://www.findbookprices.com/search/?UPC=basic+mathematics+for+aviation
