...
namespace Media_Inventory_Manager
{
    public class PrintEngine : PrintDocument
    {
        ...
        public PrintEngine()
        {
            ...
            Footer.AddText("Prager Media Inventory Program           (c) 2009-2011 Prager, Software. All Rights Reserved");
        }
    ...
    public class ListContentsV : IPrintable
    {
        ...
        public void Print(PrintElement element)
        {
          ...
          //  element.AddHeader("Contents of List");
            ...
            // now, draw the data...
           // element.AddData("Book Nbr", SKU);
           // element.AddData("Title", title);
            element.AddData("", SKU.PadRight(16,' ') + title);
            element.AddData("UPC", UPC.PadRight(16,' ') + "Location: " + location.PadRight(15,' ') + "Price: $" + price.PadRight(10,' ') + "Status: " + status);
    ...
    public class ListContentsH : IPrintable
    {
        ...
        {
            // tell the engine to draw a header...
            //   element.AddHeader("Book Number                    Title                                UPC          Location      Price    Status");
