...
OutputBaseFilename=PragerInventoryUpdate-12.9.2
...
[Icons]
Name: {userdesktop}\Prager Book Manager - 12.9.2; Filename: {pf32}\Prager\Inv\PragerInventory.exe;
...
;  Firebird installation file  <--------  check to see if it's needed  TODO
