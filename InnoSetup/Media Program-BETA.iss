...
AppID=Prager Media Inventory Program
...
OutputBaseFilename=PragerMediaInventory-1.2.2-BETA
...
[Icons]
Name: {userdesktop}\Prager Media Manager-1.2.2-BETA; Filename: {pf32}\Prager\Med\PragerMediaInventory-BETA.exe;
...
[Files]
Source: D:\Prager Software\Media Inventory Manager\bin\Release\PragerMediaInventoryManager.exe; DestDir: {pf32}\Prager\Med; DestName: PragerMediaInventory-BETA.exe; Flags: ignoreversion
