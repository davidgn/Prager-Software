...
<<<<<<< .mine
AppVerName=Prager Pricing Program Version 12.1.1
=======
AppVerName=Prager Pricing Program Version 12.1.0
>>>>>>> .r814
...
DefaultDirName={pf32}\Prager\Prc
...
<<<<<<< .mine
OutputBaseFilename=PragerPricingSetup-12.1.1
=======
OutputBaseFilename=PragerPricingSetup-12.1.0
>>>>>>> .r814
;AlwaysRestart=yes
...
[Files]
<<<<<<< .mine
Source: d:\Prager Software\Pricing Program\bin\Release\PragerPricingProgram.exe; DestDir: {pf32}\Prager\Prc; Flags: ignoreversion
Source: d:\Prager Software\Pricing Program\bin\Release\PragerPricingProgram.pdb; DestDir: {pf32}\Prager\Prc; Flags: ignoreversion
;Source: D:\Prager Software\Book Inventory Manager\bin\Release\PricingRoutines.dll; DestDir: {pf32}\Prager\Prc; DestName: PricingRoutines.dll; Flags: ignoreversion
;Source: D:\Prager Software\Book Inventory Manager\bin\Release\PricingRoutines.pdb; DestDir: {pf32}\Prager\Prc; DestName: PricingRoutines.pdb; Flags: ignoreversion
Source: d:\Upload\Prager\isxdl.dll; Flags: dontcopy
=======
Source: d:\Prager Software\Pricing\bin\Release\Prager Pricing Program.exe; DestDir: {pf32}\Prager\Prc; Flags: ignoreversion
Source: d:\Prager Software\Pricing\bin\Release\Prager Pricing Program.pdb; DestDir: {pf32}\Prager\Prc; Flags: ignoreversion
Source: D:\Prager Software\Book Inventory Manager\bin\Release\PricingRoutines.dll; DestDir: {pf32}\Prager\Prc; DestName: PricingRoutines.dll; Flags: ignoreversion
Source: D:\Prager Software\Book Inventory Manager\bin\Release\PricingRoutines.pdb; DestDir: {pf32}\Prager\Prc; DestName: PricingRoutines.pdb; Flags: ignoreversion
...
[Icons]
Name: {group}\Prager Pricing Program; Filename: {pf32}\Prager\Prc\PragerPricingProgram.exe
Name: {group}\{cm:UninstallProgram,Prager Pricing Program}; Filename: {uninstallexe}
Name: {userdesktop}\Prager Pricing Program; Filename: {pf32}\Prager\Prc\PragerPricingProgram.exe; Tasks: desktopicon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Prager Pricing Program; Filename: {pf32}\Prager\Prc\PragerPricingProgram.exe; Tasks: quicklaunchicon
...
Filename: {pf32}\Prager\Prc\PragerPricingProgram.exe; Description: {cm:LaunchProgram,Prager Pricing Program}; Flags: nowait postinstall skipifsilent
