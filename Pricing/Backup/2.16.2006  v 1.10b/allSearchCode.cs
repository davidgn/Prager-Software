...
*/
            ...
            progressBar.Minimum = 1;  // Set Minimum to 1 to represent the first file being copied.
            progressBar.Maximum = j + 1;  // Set Maximum to the total number of files to copy.
