...
namespace Prager_Book_Inventory
{
    partial class mainForm : Form
    {
        ...
        public int createBnNExport(string formattedDate) {
            ...
            //  formattedDate =>  12052012140420
            //  BnNFileName = exportPath + "BnN" + formattedDate.Substring(4, 4) + formattedDate.Substring(0, 4) +
            if(cbUploadPurgeReplace.Checked == false)
            BnNFileName = exportPath + formattedDate.Substring(4, 4) + formattedDate.Substring(0, 4) +
                    "_" + formattedDate.Substring(8, 4) + ".txt";
            else
                BnNFileName = exportPath + formattedDate.Substring(4, 4) + formattedDate.Substring(0, 4) +
                        "_" + formattedDate.Substring(8, 4) + "_purge.txt";
            ...
            //  write header
            tw.WriteLine("Transaction\tSKU\tISBN\tPrice\tComments\tCondition\tDustJacket\tFirstEdition\tSigned\tTitle\tAuthor\tFormat\t" +
        ...
        private void buildBnNTabDelimitedFile(FbDataReader data, TextWriter tw) {
            ...
            Int16 x = 0;
            Int16.TryParse(data["Quantity"].ToString(), out x);  //  Transaction
            dataBuild = x > 0 ? "A\t" : "D\t";
        ...
        //            Password = args[1],
        //            PortNumber = 22,
        //            SshHostKeyFingerprint = "ssh-dss 2048 da:48:4b:09:de:f2:a5:4e:1f:7e:63:b0:f9:b5:64:39"
        //        };
