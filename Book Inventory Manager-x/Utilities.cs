    ...
    partial class mainForm : Form
    {
            ...
            if (mtbISBN.Text.Length >= 10) {  //  only do it if there is an ISBN to check
                ...
                if (rc == true) {
                    ...
                    foreach (string key in bD.bookList.Keys) {
                        ...
                        accumulatedPrice += decimal.Parse(bD.bookList[key].price.Replace("$", ""));
                    ...
                    lNotFound.Visible = true;  //  indicate book not found...
        ...
        public int createIndexes() {
            ...
            for (int i = 0; i < nbrOfElements; i++) {
                ...
                if (tbMapAddTitle.Text == headingNames[i]) {
                    tdf.appendToTitleIndex = i;
                    ibt.appendToTitleIndex = i;
                }

                if (tbMapAddDesc2.Text == headingNames[i]) {
                    tdf.addDesc2Index = i;
                    ibt.addDesc2Index = i;
                }

                if (tbMapAddDesc3.Text == headingNames[i]) {
                    tdf.addDesc3Index = i;
                    ibt.addDesc3Index = i;
                }

                if (tbNbrOfCopies.Text == headingNames[i]) {
                    tdf.copiesIndex = i;
                    ibt.copiesIndex = i;
                }

                if (tbMapWeight.Text == headingNames[i]) {
                    tdf.bookWeightIndex = i;
                    ibt.bookWeightIndex = i;
                }

                if (tbMapAuthor.Text == headingNames[i]) {
                    tdf.authorIndex = i;
                    ibt.authorIndex = i;
                }

                if (tbMapBinding.Text == headingNames[i]) {
                    tdf.bindingIndex = i;
                    ibt.bindingIndex = i;
                }

                if (tbMapBookCond.Text == headingNames[i]) {
                    tdf.bookCondIndex = i;
                    ibt.bookCondIndex = i;
                }

                if (tbMapBookNbr.Text == headingNames[i]) {
                    tdf.bookNbrIndex = i;
                    ibt.bookNbrIndex = i;
                }

                if (tbMapBookSize.Text == headingNames[i]) {
                    tdf.bookSizeIndex = i;
                    ibt.bookSizeIndex = i;
                }

                if (tbMapCatalog.Text == headingNames[i]) {
                    tdf.priCatIndex = i;
                    ibt.priCatIndex = i;
                }
                ...
                if (tbMapSecCat.Text == headingNames[i]) {
                    tdf.secCatIndex = i;
                    ibt.secCatIndex = i;
                }

                if (tbMapCost.Text == headingNames[i]) {
                    tdf.costIndex = i;
                    ibt.costIndex = i;
                }

                if (tbMapDateSold.Text == headingNames[i]) {
                    tdf.dateSoldIndex = i;
                    ibt.dateSoldIndex = i;
                }
                ...
                if (tbMapDJCond.Text == headingNames[i]) {
                    tdf.djCondIndex = i;
                    ibt.djCondIndex = i;
                }

                if (tbMapEdition.Text == headingNames[i]) {
                    tdf.editionIndex = i;
                    ibt.editionIndex = i;
                }

                if (tbMapIllus.Text == headingNames[i]) {
                    tdf.illusIndex = i;
                    ibt.illusIndex = i;
                }

                if (tbMapISBN.Text == headingNames[i]) {
                    tdf.ISBNIndex = i;
                    ibt.ISBNIndex = i;
                }

                if (tbMapKeywords.Text == headingNames[i]) {
                    tdf.keywordsIndex = i;
                    ibt.keywordsIndex = i;
                }
                ...
                if (tbMapPrivateNotes.Text == headingNames[i]) {
                    tdf.privNotesIndex = i;
                    ibt.privNotesIndex = i;
                }

                if (tbMapPublisher.Text == headingNames[i]) {
                    tdf.publisherIndex = i;
                    ibt.publisherIndex = i;
                }

                if (tbMapPubLoc.Text == headingNames[i]) {
                    tdf.pubLocIndex = i;
                    ibt.pubLocIndex = i;
                }

                if (tbMapSignedAuthor.Text == headingNames[i]) {
                    tdf.signedAuthorIndex = i;
                    ibt.signedAuthorIndex = i;
                }

                if (tbMapSignedIllus.Text == headingNames[i]) {
                    tdf.signedIllusIndex = i;
                    ibt.signedIllusIndex = i;
                }

                if (tbMapNbrPages.Text == headingNames[i]) {
                ...
                if (tbMapType.Text == headingNames[i]) {
                    tdf.typeIndex = i;
                    ibt.typeIndex = i;
                }

                if (tbMapYearPub.Text == headingNames[i]) {
                    tdf.yearPubIndex = i;
                    ibt.yearPubIndex = i;
                }

                if (tbMapLocation.Text == headingNames[i]) {
                    tdf.locationIndex = i;
                    ibt.locationIndex = i;
                }
                ...
                if (tbMapStatus.Text == headingNames[i]) {
                    tdf.statusIndex = i;
                    ibt.statusIndex = i;
                }
