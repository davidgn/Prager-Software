...
//  this file and HomeBase.cs also
...
namespace Prager_Book_Inventory
{
    ...
    public partial class mainForm : Form
    {
        ...
        public static DateTime compileDate = DateTime.Parse("Sep 29, 2012 7:25 AM", localCulture);
        public static string versionNumber = "12.8.0 " + compileDate.ToString("dd-MMM-yyyy");
        //public static string versionNumber = "12.7.9 BETA   " + compileDate.ToString("dd-MMM-yyyy");
        ...
        *----    12.0.x    ----
        *
        -  added: inventory report sort fields  (12.7.0)
        -  changed: method to get book information (12.7.0)
         
        -  fixed: license validation routines  (12.7.1)
        -  fixed: GetInfo not returning "Author" in all cases  (12.7.1)
        -  fixed:  spelling of Hardcover on Amazon binding categories  (12.7.1)
        -  added: option when binding is "paperback", make jacket condition blank  (12.7.1)
        -  fixed:  if keywords length > 85, update was rejected (12.7.1)
        -  fixed: occasional "garbage" in author's name when using GetInfo  (12.7.1)
        -  fixed: publisher and binding in GetInfo routines  (12.7.2)
        -  changed: increased size of Amazon Associate Tag in d/b (12.7.4)
        -  restored:  GetInfo again uses Amazon for book info  (12.7.4)
        -  changed:  if Amazon Associates Tag is missing, use other site  (12.7.5)
        -  fixed:  cost would not allow decimal point  (12.7.6)
        -  added: message about using MWS keys when checking upload status  (12.7.7)
        -  changed:  did away with the need for Amazon Assocciate's Tag  (12.7.7)
        -  fixed:  now using Amazon for Get Book Info and Update Info (12.8.0)
         * 
        */
  ...
  *  
        ...
        */
        ...
        public static string storedMAC;
        ...
        private void ProgramInitialization() {
            ...
            //dbPath = "Rolf-PC:" + databasePath + dataBaseName + ".fdb";
            ...
            if (UIDdataGridView.Rows.Count > 24)  //  means table is farkeled up
...
#if COMPILED4OTHERS
            restoreOptions(@"\prager.Options.xml");  //  save options each time...
#else
...
#if COMPILED4OTHERS
            if (!networkedClient) {  //  if networking, don't check license
                int rc = 0;
                ...
                ValidateLicense LicInfo = new ValidateLicense();
            ...
            ////  get Google registered filename
            //string xmlFilename = System.AppDomain.CurrentDomain.BaseDirectory + "pragerGoogle.xml";

            //if (File.Exists(xmlFilename)) {
            //    File.SetAttributes(xmlFilename, FileAttributes.Normal);  //  set so we can read it...
            //    XmlTextReader tr = new XmlTextReader(xmlFilename);
            //    tr.Read();

            //    while (tr.Read())  // If the node has value
            //    {
            //        tr.MoveToContent();  // Move to fist element
            //        googleRegisteredFilename = tr.GetAttribute("RegFileID");
            //    }
            //}
            ...
            if (tbAWSKey.Text.Length == 0 || tbAWSSecretKey.Text.Length == 0) {
                ...
                "If you don't get them, you may be unable to get book info or lookup prices." +
                "(When you have them, enter them on the User ID's and Passwords page)", "Prager Book Inventory Manager",
                MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void lbCannedText_SelectedIndexChanged(object sender, EventArgs e) {
            switch (lbCannedText.SelectedIndex) {
                case 0:
                    tbDesc.AppendText("  " + tbCannedDesc1.Text);
                    break;
                case 1:
                    tbDesc.AppendText("  " + tbCannedDesc2.Text);
                    break;
                case 2:
                    tbDesc.AppendText("  " + tbCannedDesc3.Text);
                    break;
                case 3:
                    tbDesc.AppendText("  " + tbCannedDesc4.Text);
                    break;
                case 4:
                    tbDesc.AppendText("  " + tbCannedDesc5.Text);
                    break;
                case 5:
                    tbDesc.AppendText("  " + tbCannedDesc6.Text);
                    break;
                case 6:
                    tbDesc.AppendText("  " + tbCannedDesc7.Text);
                    break;
                case 7:
                    tbDesc.AppendText("  " + tbCannedDesc8.Text);
                    break;
                case 8:
                    tbDesc.AppendText("  " + tbCannedDesc9.Text);
                    break;
                case 9:
                    tbDesc.AppendText("  " + tbCannedDesc10.Text);
                    break;
                case 10:
                    tbDesc.AppendText("  " + tbCannedDesc11.Text);
                    break;
                case 11:
                    tbDesc.AppendText("  " + tbCannedDesc12.Text);
                    break;
                case 12:
                    tbDesc.AppendText("  " + tbCannedDesc13.Text);
                    break;
                case 13:
                    tbDesc.AppendText("  " + tbCannedDesc14.Text);
                    break;
                case 14:
                    tbDesc.AppendText("  " + tbCannedDesc15.Text);
                    break;
                case 15:
                    tbDesc.AppendText("  " + tbCannedDesc16.Text);
                    break;
                case 16:
                    tbDesc.AppendText("  " + tbCannedDesc17.Text);
                    break;
                case 17:
                    tbDesc.AppendText("  " + tbCannedDesc18.Text);
                    break;
            }
        }
            ...
            else if (dbPanelIndex.Count == 1)  //  only selected one row
            {
                ...
                if (tabTaskPanel.SelectedIndex == cASIN) { //  if we are just going after the ASIN...
                    ...
                    grabbit.getASIN(listView1, tbasinSKU.Text, tbasinTitle.Text, tbasinAuthor.Text, tbasinPublisher.Text, tbAWSKey.Text,
                        tbAWSSecretKey.Text, tbasinASIN, bookConn, dataBasePanel, dataBasePanel.SelectedIndices, tbAZAssocTag.Text);
                }
                else
                    PopulateDetailPanel(bookNbr);  //  now populate the detail panel
                ...
                {
                    //bShoppingCart.Enabled = true;  // can also add to shoppiing cart
                    bLookupPrices.Enabled = false;
                    bGetInfoWISBN.Enabled = false;
                    bUpdateInfo.Enabled = false;
                    bLookupPrices.Enabled = false;
                    ...
                    //bAddImage.Enabled = false;
                    //bUpdateImage.Enabled = false;
        ...
        private void prepareForPricingService() {
            ...
            parms.Insert(47, tbAZAssocTag.Text);   //  new 11.5.0  (not needed?)
        ...
        public static void ShowThreadExceptionDialog(string title, Exception ex, string mtv) {
            ...
            string emailData = DateTime.Now + "\n\rVersion: " + versionNumber +
                ...
                "\n\r storedMAC: " + storedMAC + "     MAC: " + MACAddress + "      License: " + eDate +
        ...
        private void bUpdateInfo_Click(object sender, EventArgs e) {
            ...
            if (cbUseAmazon4BookInfo.Checked) {
                ...
                notFoundFlag = BookInfoLookup(mtbISBN.Text, tbAWSKey.Text, tbMerchantID.Text, tbMarketplaceID.Text,
                    tbAWSSecretKey.Text);
            }
            else {
                GetBookInfo gbi = new GetBookInfo();
                notFoundFlag = gbi.getBookInfo(mtbISBN, tbTitle, tbAuthor, tbPub, tbPages, tbYear, coBinding, coEdition);
            }
        ...
        private void bPrintInvReport_Click(object sender, EventArgs e) {
            ...
            ivr.printInvReport(this, dataBasePanel, bookConn, exportPath);
        }
        ...
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        //-  clear report sort fields to unchecked
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        private void bClearSortFields_Click(object sender, EventArgs e) {

            this.cbIRSortType.CheckState = CheckState.Unchecked;
            this.cbIRSortSize.CheckState = CheckState.Unchecked;
            this.cbIRSortCost.CheckState = CheckState.Unchecked;
            this.cbIRSortDateA.CheckState = CheckState.Unchecked;
            this.cbIRSortTitle.CheckState = CheckState.Unchecked;
            this.cbIRSortDateU.CheckState = CheckState.Unchecked;
            this.cbIRSortSigned.CheckState = CheckState.Unchecked;
            this.cbIRSortPriCat.CheckState = CheckState.Unchecked;
            this.cbIRSortSKU.CheckState = CheckState.Unchecked;
            this.cbIRSortNotes.CheckState = CheckState.Unchecked;
            this.cbIRSortStatus.CheckState = CheckState.Unchecked;
            this.cbIRSortAuthor.CheckState = CheckState.Unchecked;
            this.cbIRSortInvNbr.CheckState = CheckState.Unchecked;
            this.cbIRSortEd.CheckState = CheckState.Unchecked;
            this.cbIRSortSecCat.CheckState = CheckState.Unchecked;
            this.cbIRSortIllus.CheckState = CheckState.Unchecked;
            this.cbIRSortNoReprice.CheckState = CheckState.Unchecked;
            this.cbIRSortISBN.CheckState = CheckState.Unchecked;
            this.cbIRSortPages.CheckState = CheckState.Unchecked;
            this.cbIRSortLoc.CheckState = CheckState.Unchecked;
            this.cbIRSortWt.CheckState = CheckState.Unchecked;
            this.cbIRSortCond.CheckState = CheckState.Unchecked;
            this.cbIRSortQty.CheckState = CheckState.Unchecked;
            this.cbIRSortPrice.CheckState = CheckState.Unchecked;
            this.cbIRSortShip.CheckState = CheckState.Unchecked;
            this.cbIRSortPub.CheckState = CheckState.Unchecked;
            this.cbIRSortBinding.CheckState = CheckState.Unchecked;
            this.cbIRSortPubLoc.CheckState = CheckState.Unchecked;
            this.cbIRSortYearPub.CheckState = CheckState.Unchecked;
            this.cbIRSortJacket.CheckState = CheckState.Unchecked;
            this.cbIRSortKeywords.CheckState = CheckState.Unchecked;
            this.cbIRSortDesc.CheckState = CheckState.Unchecked;
            chosenSortFields = "";
        }
